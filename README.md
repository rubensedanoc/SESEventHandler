...
- El repo debe guardar solo la plantilla [k8s/hpa.example.yaml](/Users/rubensedano/Documents/Codex/SESEvents/k8s/hpa.example.yaml), para que ajustes el autoscaling localmente segun tu trafico y tu `metrics-server`.
